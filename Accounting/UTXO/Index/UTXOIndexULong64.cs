...
namespace BToken.Accounting
{
  ...
  {
    class UTXOCacheULong64 : UTXOIndex
    {
      ...
      public UTXOCacheULong64(): base(1, "ULong64")
      { }
    ...
    class UTXOIndexULong64DataBatch : UTXODataItem
    {
      public UTXOIndexULong64DataBatch(int tXCount)
      {
