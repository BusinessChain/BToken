...
namespace BToken.Chaining
{
  public partial class Blockchain
  {
    class UTXOMerger
    {
      ...
      public UTXOMerger(Blockchain blockchain)
      {
        Blockchain = blockchain;
      }
      ...
      public async Task StartAsync()
      {
        ...
        try
        {
          while (true)
          {
            ...
            Blockchain.InsertUTXOsUInt32(batch.UTXOsUInt32);
            Blockchain.InsertUTXOsULong64(batch.UTXOsULong64);
            Blockchain.InsertUTXOsUInt32Array(batch.UTXOsUInt32Array);
            Blockchain.SpendUTXOs(batch.Inputs);
      ...
      void ArchiveState()
      {
        ...
        Parallel.ForEach(Blockchain.Tables, t =>
        {
      ...
      bool TryLoadUTXOState()
      {
        try
        {
          ...
          Parallel.ForEach(Blockchain.Tables, t => t.Load());

          return true;
        }
        catch (Exception ex)
        {
          for (int c = 0; c < Blockchain.Tables.Length; c += 1)
          {
            Blockchain.Tables[c].Clear();
          }
      ...
      void LogCSV(UTXOBatch batch)
      {
        ...
        string logCSV = string.Format(
          ...
          ratioMergeToParse,
          Blockchain.Tables[0].GetMetricsCSV(),
          Blockchain.Tables[1].GetMetricsCSV(),
          Blockchain.Tables[2].GetMetricsCSV());
